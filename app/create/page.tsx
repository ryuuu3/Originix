          ...
          <div className="glass-strong p-8 rounded-2xl mb-8">
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full px-6 py-4 bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg hover:shadow-purple-500/50 transition-all flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
          ...
          {generated && (
            ...
            >
              ...
              <div className="flex gap-4">
                <button
                  onClick={handleGenerate}
                  className="flex-1 px-6 py-4 glass rounded-xl hover:glass-strong transition-all flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="flex-1 px-6 py-4 bg-gradient-to-r from-primary-500 to-pink-500 rounded-xl font-bold hover:shadow-lg hover:shadow-primary-500/50 transition-all flex items-center justify-center gap-2"
                >
